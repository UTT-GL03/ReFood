...
Un autre point marquant de ce projet concerne notre rapport aux fonctionnalités elles-mêmes. En prenant du recul, ce projet m’a surtout fait évoluer dans ma manière de voir le développement web (Ahamad). Avant ReFood, je me concentrais principalement sur le résultat visible : que l’application fonctionne, qu’elle soit fluide et qu’elle réponde aux besoins demandés. Les analyses réalisées avec GreenIT Analysis et GreenFrame m’ont obligé à regarder d'autres aspects en profondeur et à comprendre que chaque choix technique, même banal en apparence, a un coût réel en ressources. Ce qui m’a marqué, c’est que ces impacts ne viennent pas seulement de calculs complexes, mais aussi de gestes simples et répétés : charger une page, afficher une image, laisser l’utilisateur naviguer plus longtemps que nécessaire. Ce projet m’a donc appris à adopter une posture plus responsable en tant que futur ingénieur, en intégrant dès la conception des questions de sobriété, et pas uniquement en phase d’optimisation finale comme je faisais auparavant avec d'autres outils comme Lighthouse. Cette expérience nous a ainsi incités à réfléchir de manière systémique à l’impact environnemental de nos applications et à envisager chaque fonctionnalité, chaque action répétée et chaque élément affiché sous l’angle de leur coût énergétique et écologique. Nous comptons appliquer cette approche dans nos futurs projets pour créer des services web plus responsables et durables. 
